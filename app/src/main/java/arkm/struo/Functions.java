        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String city = json.getString("name").toUpperCase(Locale.CANADA) + ", " + json.getJSONObject("sys").getString("country");
                    String description = details.getString("description").toUpperCase(Locale.CANADA);
